...
enum ResFlag
{
	...
	RES_CUSTOM			=	1	<<	2,	//! Is this resource one that corresponds to another player's customization or is it a server startup resource.
	RES_REQUESTED		=	1	<<	3,	//! Already requested a download of this one
	RES_PRECACHED		=	1	<<	4,	//! Already precached
	RES_ALWAYS			=	1	<<	5,	//! download always even if available on client	
	RES_CHECKFILE		=	1	<<	7,	//! check file on client
};
